...
export const vehicleInspections = pgTable("vehicle_inspections", {
  ...
  photoFrontLat: real("photo_front_lat"),
  photoFrontLng: real("photo_front_lng"),
  photoFrontTimestamp: timestamp("photo_front_timestamp"),
  photoBackLat: real("photo_back_lat"),
  photoBackLng: real("photo_back_lng"),
  photoBackTimestamp: timestamp("photo_back_timestamp"),
  photoLeftLat: real("photo_left_lat"),
  photoLeftLng: real("photo_left_lng"),
  photoLeftTimestamp: timestamp("photo_left_timestamp"),
  photoRightLat: real("photo_right_lat"),
  photoRightLng: real("photo_right_lng"),
  photoRightTimestamp: timestamp("photo_right_timestamp"),
